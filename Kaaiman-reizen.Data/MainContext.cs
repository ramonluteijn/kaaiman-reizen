...
public class MainContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder builder)
    {
        builder.Entity<TravelLeader>().HasData(
            new TravelLeader { Id = 1, Name = "Jan de Vries", PhoneNumber = "06-12345678", AmountOfTrips = 8, WhenAvailable = "April–juni 2025" },
            new TravelLeader { Id = 2, Name = "Maria Jansen", PhoneNumber = "06-87654321", AmountOfTrips = 12, WhenAvailable = "Hele jaar" }
        );
